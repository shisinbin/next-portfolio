    ...
    <PageLayout>
      <section>
        ...
        <div className={styles.content}>
          ...
          <p>
            I've grown to really enjoy working in the React ecosystem
            - the component-driven approach just makes sense to me. I
            like how it encourages encapsulation, reuse, and small,
            meaningful pieces that come together to form something
            bigger.
          </p>
          <p>
            The path so far hasn't been easy. Web development moves
            fast, and it's easy to feel stuck or behind. But I'm still
