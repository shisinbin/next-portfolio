...
<Figure
  src='/images/projects/weather-dashboard/cover.png'
...
<Callout>
  A proper write-up is coming. This is largely a rehash from my
  [GitHub repo README
  file](https://github.com/shisinbin/weather-dashboard).
</Callout>
...
<Figure
  src='/images/projects/weather-dashboard/demo.mp4'
